    ...
    <body data-spy="scroll" data-target="#navbar-menu" data-offset="100">
        ...
        <nav class="navbar navbar-default navbar-fixed white bootsnav on no-full no-background">
            ...
            <div class="container">            
                ...
                <div class="attr-nav">
                    <ul>
                        <li class="side-menu"><a href="#"><p>More</p> <i class="fa fa-bars"></i></a></li>
                    </ul>
                </div>
                ...
                <div class="navbar-header">
                    ...
                    <a href="#brand" class="navbar-brand">
                        <img alt="" class="logo logo-display" src="images/bgstudio.png">
                    ...
                    <div class="item active">
                        ...
                        <div class="container caption_area">
                            <div class="carousel-caption">
                                <h3>HOW CAN WE BUILD</h3>
                                <h1>AN AMAZING SITE</h1>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been the.</p>

                                <a href="" class="banner_btn">View Portfolio</a>
                            </div>					
                        </div>
                    </div>
                    <div class="item">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="contact_content">
                                <h4>Search your dentist now</h4>
                        			
                            </div>					
                        </div>
                        <div class="col-md-7">
                            <form role="form" class="form-inline" action="doctor.php" method="POST">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="unam" placeholder="Type here name/area/locality/degree" name="search">
                                </div>
                              
                                <button type="submit" class="btn submit_btn" name="submit-search">Search!</button>
                            </form>					
                        </div>
                    </div>
                </div>
        ...
        <section id="services">
            <div class="container text-center">
                    ...
                    if(isset($_POST['submit-search'])){
                        ...
                        $sql = "SELECT * FROM doctor_info WHERE name LIKE '%$search%' OR degree LIKE '%$search%'";
                        ...
                        if($queryResults > 0){
                            while ($row = mysqli_fetch_assoc($result) ){
                               ?>
                                    ...
                                    <?php
                                    echo "<h4>".$row['name']."</h4>
                                    <p>Clicnic Name: ".$row['clicnic_name']."</p>
